      ...
      <div class="table-responsive cart_info"> 
              ...
              ?>
                         ...
                         <!-- <td></td> -->
                          ...
                          <td>Kes. <?php echo  $result->PRODISPRICE ?></td>
                          <td>Kes. <output><?php echo $_SESSION['gcCart'][$i]['price']?></output></td>
                        </tr>
              <?php
              ...
              ?>
                ...
                <div class="  pull-right">
                  <p align="right">
                  <div > Total Price :   Kes. <span id="sum">0.00</span></div>
                   <div > Delivery Fee : Kes. <span id="fee">0.00</span></div>
                   <div> Overall Price : Kes. <span id="overall"><?php echo $tot ;?></span></div>
