            ...
            <tr>
              ...
              <table class="fixnmix-table" id="list">
                ...
                <tr>
                  ...
                  <th>Product Name</th>
                  <th>Quantity</th>
                  <th style="width:100px">PriloadResultLisce</th>
              ...
              ?>
                         ...
                         <td></td>
                          ...
                          <td>Kes. <?php echo  $result->PRICE ?></td>
                          <td>Kes. <output><?php echo $_SESSION['fixnmix_cart'][$i]['price']?></output></td>
                        </tr>
              <?php
                        }
              ...
              <!--   <div class="col-md-6 pull-left">
                ...
                <div class="col-md-4 pull-right">
                  <!-- <div>Total Price : Kes. <?php echo number_format($tot,2);?></div> -->
                  <!-- <div>Delivery Fee : Kes. <?php echo number_format($price,2); ?></div> -->
                  <div>Overall Price : Kes. <?php echo number_format($cur->TOTALPRICE,2); ?></div>
                </div>
              </div>
