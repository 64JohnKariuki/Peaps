	...
	"post">
				...
				<?php
				  ...
				  $query = "SELECT * 
						...
						echo '<tr>';  
				  		...
				  		echo '<td> Kes. '.number_format($result->PROPRICE,2).' </td>';
				  		echo '<td align="center" >'. $result->ORDEREDQTY.'</td>';
				  		?>
				  		 <td> Kes. <output><?php echo number_format($result->ORDEREDPRICE,2); ?></output></td> 
				  		<?php
       ...
       <div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		<p align="right">Total Price : Kes. <?php echo number_format($subtot,2);?></p>
		  		<p align="right">Delivery Fee : Kes. <?php echo number_format($cur->DELFEE,2); ?></p>
		  		<p align="right">Overall Price : Kes. <?php echo number_format($cur->PAYMENT,2); ?></p>
		  	</div>
		  </div> 
		</div>   
