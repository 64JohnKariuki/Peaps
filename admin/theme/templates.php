...
<link href="<?php echo web_root; ?>admin/css/ekko-lightbox.css" rel="stylesheet">
  ...
  <?php
    ...
    if($res>0){
    $order = '<span style="color:green;">('.$res.')</span>';
    }else{
        $order = '<span> ('.$res.')</span>';
    }
?>
        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" >Peaps Dashboard</a>
            </div>
            <!-- /.navbar-header -->
  ...
  format: 'mm/dd/yyyy',
    ...
    forceParse: 0,
     changeMonth: true,
      ...
      <footer><p  style="text-align: center;font-weight: bold;">Copyright &copy; Peaps Limited </p></footer>
</html>