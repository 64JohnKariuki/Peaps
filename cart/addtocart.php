      ...
      <div class="table-responsive">
       <div  class="fixnmix_scroll_carttwo" >
         ...
         <tbody > 
            ...
            ?>
                      <tr>
                        ...
                        <td>Kes. <?php echo number_format($result->PRICE,2) ?></td>
                        ...
                        <td>Kes. <output id="Osubtot<?php echo $result->PRODUCTID ?>"><?php echo   $_SESSION['fixnmix_cart'][$i]['price'] ; ?></output>
        ...
        ?>
                  ...
                  <table  >
                  <tfoot >
                     <strong><h1 align="right">Total Price : Kes. <span style="margin-right:3%"  id="sum">0.00</span></h1></strong></td>
